...
mysql_select_db($database_unique, $unique);
$query_skills = sprintf("SELECT skills.student_id, CONCAT_WS(' ',student_info.student_Lname, student_info.student_Fname) AS name, skills.skill_id FROM skills, student_info WHERE skills.skill_id=%s AND skills.student_id =student_info.student_id", GetSQLValueString($var1_skills, "int"));
...
<div id="line"></div>
		...
		<div id="long_txt_pix">
		  <h1>&nbsp;</h1>
		  <form id="form1" method="get" action="delete_skills_confirmed.php">
  <p>&nbsp;</p>
<table width="90%" border="0" align="center">
        <tr>
          ...
          <td width="63%" align="center"><h1>Are you Sure You want to delete<br />
            ...
            <h2> </h2>
            <h2><?php echo $row_skills['name']; ?>'s Skills </h2>
        ...
        <tr>
          ...
          <td align="center"><p>
            ...
            <p>
              ...
              No
  <input name="id" type="hidden" id="id" value="<?php echo $row_skills['skill_id']; ?>" />
            </p></td>
        </tr>
	          <tr>
	            <td align="center">&nbsp;</td>
