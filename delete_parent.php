...
$query_parent = sprintf("SELECT parent.parent_id, parent.parent_lname, parent.parent_fname FROM parent WHERE parent.parent_id=%s", GetSQLValueString($colname_parent, "text"));
...
<div id="line"></div>
		...
		<div id="long_txt_pix">
		  ...
		  <h2><?php echo $row_parent['parent_lname']; ?> <?php echo $row_parent['parent_fname']; ?></h2>
		  <h2>&nbsp;</h2>
		  <h2>with ID No: <?php echo $row_parent['parent_id']; ?></h2>
		  <h1>From the database?</h1>
		  <form id="form1" method="post" action="delete_parent_confirmed.php">
		    <blockquote>
		      <p>&nbsp;	          </p>
		      <table width="14%" border="0" align="center">
		        <tr>
                  ...
                  No
                  <input name="id" type="hidden" id="id" value="<?php echo $row_parent['parent_id']; ?>" />
                  </p></td>
	            </tr>
		        <tr>
