...
$query_student = sprintf("SELECT student_info.student_Lname, student_info.student_Fname, student_info.student_id FROM student_info WHERE student_info.student_id=%s", GetSQLValueString($colname_student, "text"));
...
<div id="line"></div>
		...
		<div id="long_txt_pix">
		  <h1><img src="images/roadsafety.jpg" alt="" width="191" height="117" />Are you Sure You want to delete<br />
		  </h1>
		  <p>&nbsp; </p>
		  <h2><?php echo $row_student['student_Lname']; ?> <?php echo $row_student['student_Fname']; ?></h2>
		  <h2>with ID No: <?php echo $row_student['student_id']; ?></h2>
		  <h1>From the database?</h1>
		  <form id="form1" method="post" action="delete_user_confirmed.php">
		    <blockquote>
		      <p>&nbsp;	          </p>
		      <table width="14%" border="0" align="center">
		        <tr>
                  ...
                  No
                  <input name="id" type="hidden" id="id" value="<?php echo $row_student['student_id']; ?>" />
                  </p></td>
	            </tr>
		        <tr>
		          <td><input name="ansa" type="submit" class="searchbutton" id="ansa" value="Yes" /></td>
	            </tr>
	          </table>
		      <p>&nbsp;</p>
		      <p>&nbsp;</p>
