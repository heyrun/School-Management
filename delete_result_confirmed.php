...
if ((isset($_GET['id'])) && ($_GET['id'] != "")) {
  $deleteSQL = sprintf("DELETE FROM student_results WHERE result_id=%s",
                       GetSQLValueString($_GET['id'], "int"));

  mysql_select_db($database_unique, $unique);
  $Result1 = mysql_query($deleteSQL, $unique) or die(mysql_error());

  $deleteGoTo = "enter_result_class.php?class=" . $_GET['class'] . "";
...
elseif(isset($_GET['delete']) && $_GET['delete']=="no"){
	header("location:enter_result_class.php?class=".$_GET['class']."");
}
