...
$query_result = sprintf("SELECT CONCAT_WS(' ', student_info.student_Lname, student_info.student_Fname) AS name, student_results.cat1, student_results.cat2, student_results.exam, subject.subject_name, student_results.grade, student_results.result_id FROM student_info, student_results, subject WHERE student_results.result_id=%s AND student_results.student_id = student_info.student_id AND student_results.subject = subject.subject_id", GetSQLValueString($colname_result, "int"));
...
<div id="line"></div>
		...
		<div id="long_txt_pix">
		  <h1>&nbsp;</h1>
		  <form id="form1" method="get" action="del_result.php">
  <p>&nbsp;</p>
<table width="90%" border="0" align="center">
        <tr>
          ...
          <td width="63%" align="center"><h1>Are you Sure You want to delete<br />
            ...
            <h2><?php echo $row_result['subject_name']; ?> </h2>
            <h2>of: <?php echo $row_result['name']; ?></h2>
        ...
        <tr>
          ...
          <td align="center"><p>
            ...
            <p>
              ...
              No
  <input name="id" type="hidden" id="id" value="<?php echo $row_result['result_id']; ?>" />
