...
<div id="right">	
			<div id="rl">
              ...
              <p>&nbsp;</p>
				...
				<blockquote>
          <p><span class="open">As an administrator, you have certain privileges on the database. I hereby implore you to please thread with care as some of the actions are irreversible. Please do not hesitate to contact the web admin for any help.</span><span class="close"></span>          <br />
        </p>
        </blockquote>
		  </div>
</div>
