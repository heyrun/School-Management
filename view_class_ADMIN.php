...
$query_mainclass = "SELECT DISTINCT `class`.class_name, `class`.class_id FROM `class`, subject_teacher ORDER BY `class`.class_name";
...
<div id="line"></div>
		...
		<div id="long_txt_pix">
		  <form name="form1" id="form1" method="get" action="view_student_ADMIN.php">
...
?>
		      ...
		      <tr>
		        <td>Select Action</td>
		        <td><label>
		          <select name="action" id="action" tabindex="2">
		            <option value="1">View Results</option>
		            <option value="2">Enter Comments</option>
	              </select>
	            </label></td>
	          </tr>
		      <tr>
