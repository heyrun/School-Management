...
<div id="right">	
			<div id="rl">
              ...
              <h3>Welcome,  <?php echo $row_Sinfo['lname']; ?> <?php echo $row_Sinfo['fname']; ?></h3>
              <p>&nbsp;</p>
          
				<blockquote>
          <p><span class="open">As an adminstrator, you have certain priveledges on the database. I hereby implore to please tred with care as some of the actions are irreversible. Please do no exhitate to contact the web admin for any help.</span><span class="close"></span>          <br />
        </p>
        </blockquote>
		  </div>
</div>
