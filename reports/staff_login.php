  ...
  <div id="right">	
			<div id="long_txt_pix">
              ...
              <form action="../search_result.php" name="assign_subject" id="parent_data" method="get">
                <table width="52%" border="0" align="center" cellpadding="6">
                  <tr>
                    <td colspan="2" align="center">&nbsp;</td>
                  </tr>
                  <tr class="hlite">
                    <td height="26" colspan="2" align="left"><strong>Total Number of data <?php echo $totalRows_staff_user ?></strong></td>
                  </tr>
                  <tr class="hlite">
                    <td width="50%" align="left"><h2>Staff Name</h2></td>
                    <td width="50%" align="left"><h2>Staff Username</h2></td>
                  </tr>
                  <?php $count=0; ?>
                  <?php do { ?>
                    <tr <?php if ($count++ %2) echo 'class="hlite"'; ?>>
                      <td><p><strong></strong><?php echo $row_staff_user['name']; ?></p></td>
                      <td><p><strong></strong><?php echo $row_staff_user['user_name']; ?></p></td>
                    </tr>
