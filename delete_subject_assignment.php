...
mysql_select_db($database_unique, $unique);
$query_sub_tea = sprintf("SELECT CONCAT_WS(' ', staff.lname, staff.fname) AS name, `class`.class_name, subject.subject_name, subject_teacher.id FROM staff, `class`, subject, subject_teacher WHERE subject_teacher.id=%s AND subject_teacher.staff_id =staff.staff_id AND subject_teacher.subject_id =subject.subject_id AND subject_teacher.class_id =`class`.class_id", GetSQLValueString($var1_sub_tea, "int"));
			...
			<div id="long_txt_pix">
              ...
              <form name="assign_subject" id="assign_subject" method="POST">
                <table width="95%" border="1">
                  ...
                  <tr>
                    <td align="right"><span class="BIGFONT">Subject</span></td>
                    <td><span class="BIGFONT"><?php echo $row_sub_tea['subject_name']; ?></span></td>
                  </tr>
                  <tr>
                    <td align="right"><span class="BIGFONT">Teacher</span></td>
                    <td><span class="BIGFONT"><?php echo $row_sub_tea['name']; ?></span></td>
                  </tr>
                  <tr>
                    <td align="right"><span class="BIGFONT">class</span></td>
                    <td class="BIGFONT">
<input name="id" type="hidden" id="id" value="<?php echo $row_sub_tea['id']; ?>" />
                    <?php echo $row_sub_tea['class_name']; ?></td>
                  </tr>
                  <tr>
                    <td>&nbsp;</td>
                    <td><label>
