		  ...
		  <!-- <form action="<?php echo $editFormAction; ?>" name="form1" id="form1" method="POST"> -->
		    <table width="100%" border="1">
	          ...
	          <tr>
	            ...
	            <td>|<a href="reports/report_result.php?id=<?php echo $row_students['student_id']; ?>&amp;term=1" target="_blank"> 1st Term </a>| <a href="reports/report_result.php?id=<?php echo $row_students['student_id']; ?>&amp;term=2" target="_blank">2nd Term </a>| <a href="reports/report_result.php?id=<?php echo $row_students['student_id']; ?>&amp;term=3&amp;session=2013/2014" target="_blank">3nd Term </a>|</td>
              </tr>
