...
<div id="line"></div>
		...
		<div id="long_txt_pix">
		  <h1>&nbsp;</h1>
		  <form id="form1" method="get" action="delete_result_commnet_confirmed.php">
  <p>&nbsp;</p>
<table width="90%" border="0" align="center">
        <tr>
          ...
          <td width="63%" align="center"><h1>Are you Sure You want to delete<br />
            ...
            <h2> </h2>
            <h2>the comment of <?php echo $row_comment['name']; ?>'s </h2>
        ...
        <tr>
          ...
          <td align="center"><p>
            ...
            <p>
              ...
              No
  <input name="id" type="hidden" id="id" value="<?php echo $row_comment['report_id']; ?>" />
            </p></td>
        </tr>
	          <tr>
	            <td align="center">&nbsp;</td>
